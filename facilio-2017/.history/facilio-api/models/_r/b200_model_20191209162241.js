...
module.exports = class B200_MODEL extends Model {
  ...
  * @param pvLOGIN
  */
  _reportOfTabB200_p6(params, callback) {
  ...
  * @param pvLOGIN
  */
  _reportOfTabB200_p5(params, callback) {

    const procName = this.SYNONYM.R2017_CUR + 'ReportOfTabB200',
      pnFH000 = !!params.pnFH000 ? +params.pnFH000 : 0,
      pnFH200 = !!params.pnFH200 ? +params.pnFH200 : 0,
      pnFN850 = !!params.pnFN850 ? +params.pnFN850 : 0,
      pnDAYS = !!params.pnDAYS ? +params.pnDAYS : 0,
      pvLOGIN = !!params.pvLOGIN ? params.pvLOGIN : null
  ...
  * @param pvLOGIN
  */
  _reportOfTabN850F(params, callback) {
  ...
  * @param pvLOGIN
  */
  _reportOfTabB200FAC(params, callback) {
  ...
  * @param pvLOGIN
  */
  _reportOfTabB200EM(params, callback) {
