<div class="page-pm">
  <div class="container-fluid">
    <div class="pm-toolbar">
      <div class="row">
        <div class="col-4">
          <a href="<?= base_url(); ?>b200BT.html" class="btn qb-button btn-pm active"><?= lang('_lubrication_maintenance'); ?></a>
          <a href="<?= base_url(); ?>b350BT.html" class="btn qb-button"><?= lang('_maintenance_of_limits'); ?></a>
        </div>
        <div class="col-8">
    ...
    <div class="item-filter d-none">
      <ul>
        <li>
          ...
          <span class="sp-title"><?= lang('_all'); ?></span>
        </li>
        <li>
          <label class="custom-control custom-checkbox">
            <input type="checkbox" class="custom-control-input cb-table" value="1" checked>
