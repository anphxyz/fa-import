...
module.exports = class B000_MODEL extends Model {
  ...
  *  @param pvLOGIN
  */
  _listOfTabB000(req_PARAM, callback) {
  ...
  */
  ...
  /**
    ...
    * @param pvLOGIN
    */
  _stornoTabB000(req_PARAM, callback) {
