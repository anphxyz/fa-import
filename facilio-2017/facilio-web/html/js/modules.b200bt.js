...
window.onload = function () {
  b200BTPlugin.getInstance().eventListener();
  b200BTPlugin.getInstance().loadCombTabN850(function(){
    b200BTPlugin.getInstance().loadCombTabN100L(function(){
      b200BTPlugin.getInstance().loadListOfTabB200();
    });
  });
}

const b200BTPlugin = (function () {
  var instance;
  function init() {
    ...
    function _comb_n100l(n100l, pn100) {
      ...
      if (n100l.length > 0) {
        ...
        n100l.forEach(function (item) {
          $div.append($('<a>', { href: '#', class: (!!pn100 && item.VAL2 === pn100) ? 'dropdown-item qb-dropdown-item active' : "dropdown-item qb-dropdown-item", html: item.LABEL || '', lang: item.VAL }));
        });
      }
      ...
      return $('<div>', { class: (!!pn100) ? 'dropdown comb-n100g-lstb200' : "dropdown" })
        ...
        .append($('<input>', { type: 'hidden', value: (!!objN100L) ? objN100L.VAL : n100l[0].VAL }))
        .append($div);
    }
