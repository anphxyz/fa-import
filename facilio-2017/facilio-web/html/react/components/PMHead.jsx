...
export default class PMHead extends React.Component {
    ...
    return (
      <thead>
        <tr>
          ...
          <td rowSpan="2" className="td4">{lang._require_technical}</td>
          <td rowSpan="2" className="td5">{lang._important_work}</td>
          <td rowSpan="2" className="td6">{lang._material_code}</td>
          <td rowSpan="2" className="td7">{lang._amount}</td>
          <td rowSpan="2" className="td8">{lang._status}</td>
